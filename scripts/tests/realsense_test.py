...
class Realsense:
    def __init__(self, camera):
        ...
        self.is_hand_camera = self.serial_number == '243222071972'
    ...
    def read_camera(self):
        ...
        # Read Camera #
        timestamp_dict = {self.serial_number + "_read_start": 1111}
        frames = self.pipeline.wait_for_frames()
        aligned_frames = self.align.process(frames)
        timestamp_dict[self.serial_number + "_read_end"] = 2222
...
for camera in cameras:
    print('serial_number: ', camera.serial_number)
    print('current_mode: ', camera.current_mode)
    print('hand_camera: ', camera.is_hand_camera)
    ...
    image = data_dict['image'][camera.serial_number]
    print('image: ', image)
